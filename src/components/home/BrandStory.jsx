export default function BrandStory() {
  ...
  return (
    <section id="brand-story" className="py-12 md:py-16 bg-deep-green text-white">
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-center">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-earth-200 text-sm leading-relaxed mb-4">
              ...
              founder began blending cold-pressed oils and medicinal herbs. Every bar is still made by hand — no
              machines, no shortcuts, no compromise.
            </p>
