...
export default function HeroBanner() {
  return (
    <section className="relative bg-gradient-to-br from-earth-800 via-deep-green to-earth-900 text-white overflow-hidden">
      {/* Decorative blobs */}
      <div className="absolute -top-12 -right-12 w-56 h-56 rounded-full bg-saffron-500/10 pointer-events-none" aria-hidden="true" />
      <div className="absolute -bottom-10 -left-10 w-44 h-44 rounded-full bg-saffron-400/10 pointer-events-none" aria-hidden="true" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24 lg:py-32 flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        <div className="flex-1 text-center md:text-left">
          <span className="inline-block bg-saffron-500/20 text-saffron-300 text-xs font-semibold tracking-widest uppercase px-3 py-1 rounded-full mb-4">
            Soaps · Shampoos · Perfumes · GST Inclusive
          </span>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
            ...
            <a
              href="#brand-story"
              className="min-h-[48px] flex items-center justify-center border border-white/30 hover:bg-white/10 text-white font-semibold px-8 py-3 rounded-xl text-sm transition-colors"
            >
              Our Story
            </a>
          </div>
