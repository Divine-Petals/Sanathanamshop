...
function ProductForm({ editingProduct, onClose, onSubmit }) {
...
export default function AdminPage() {
  const { products, addProduct, updateProduct, removeProduct, toggleAvailability } = useProducts()
