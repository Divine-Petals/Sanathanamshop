      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-earth-100 shadow-sm p-6">
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            {/* Username */}
            <div>
              <label className="block text-xs font-semibold text-earth-600 mb-1" htmlFor="login-username">
                Username
              </label>
              <input
                id="login-username"
          ...
          {/* Hint */}
          <div className="mt-5 rounded-xl bg-earth-50 border border-earth-100 px-4 py-3 text-xs text-earth-500 space-y-0.5">
            <p className="font-semibold text-earth-600">Demo credentials</p>
            <p>Username: <span className="font-mono text-deep-green">admin</span></p>
            <p>Password: <span className="font-mono text-deep-green">divine@123</span></p>
          </div>
        </div>
      </div>
    </div>
